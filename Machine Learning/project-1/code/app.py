...
diabetes_model = pickle.load(open('C:\\Users\\bariu\\Python\\Multiple-Disease-Prediction\\diabetes_model.sav','rb'))

heart_disease_model = pickle.load(open('C:\\Users\\bariu\\Python\\Multiple-Disease-Prediction\\heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('C:\\Users\\bariu\\Python\\Multiple-Disease-Prediction\\parkinsons_model.sav','rb'))
